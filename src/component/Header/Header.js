            ...
            <div className="flex-1 md:flex md:items-center md:justify-between md:float-none">
              <div className="flex flex-col md:flex-row md:items-center md:mx-8  ">
                <div className=" lg:flex hidden">
                  {/* <a
                    href="/home"
                    className=" px-2 py-1 mx-2 mt-2 text-md font-medium text-gray-800 transition-colors duration-200 transform rounded-md md:mt-0 dark:text-gray-200 hover:text-gray-500 "
                  >
                    Home
                  </a> */}
                  <a
