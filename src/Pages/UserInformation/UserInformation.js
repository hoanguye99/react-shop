...
const UserInformation = () => {
    return (
      <section className="h-full bg-gray-100 bg-opacity-50">
        <form className="container max-w-2xl mx-auto  md:w-6/12">
          <div className="p-4 bg-gray-100 border-t-2 border-gray-300 rounded-lg bg-opacity-5">
            <div className="max-w-sm mx-auto md:w-full md:mx-0">
              <div className="inline-flex items-left-0 space-x-4">
                <a href="#" className="block relative items-left-0">
                  <img
                    alt="profile"
                ...
                <h1 className="text-gray-600">TEST AVATAR</h1>
              </div>
            </div>
          </div>
          <div className="space-y-6 bg-white">
            ...
            <div className="items-center w-full p-8 space-y-4 text-gray-500 md:inline-flex md:space-y-0">
              ...
              <div className="text-center md:min-w-min md:pl-6">
                <button
                  type="button"
            ...
            <hr />
            <div className=" px-4 pb-4 ml-auto text-gray-500 md:w-2/12">
              <button
                type="submit"
